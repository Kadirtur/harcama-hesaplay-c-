...
function addExpense(event) {
  ...
  // c- divin içeriğini belirleme
  expenseDiv.innerHTML = `
  <h2 id="title">${title}</h2>
<h2 id="price">${price}</h2>
<div class="btns">
    <img id="update" src="image/money.png" alt="" title="pay">
    <img id="delete" src="image/delete.png" alt="" title="delete"></img>
    </div>
`;
  //d- oluşan kartı hmtle göndeerme
